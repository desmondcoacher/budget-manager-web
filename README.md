...
Each transaction includes details like type (income/expense), amount, and description:<br><br>
*```transactions_database = {"balance": 0, "transactions": []}```*
<br>Each transaction will be stored separately *(for example)*:<br><br>
