...
The program maintains a dictionary that stores the user's balance and a list of transactions.<br><br>
Each transaction includes details like type (income/expense), amount, and description:<br><b
*```transactions_database = {"balance": 0, "transactions": []}```*
<br><br>Each transaction will be stored separately *(for example)*:<br><br>
